...
@section('content')
    ...
    <div class="container mt-5">
        <div class="text-center">
            <span>
                <i style="font-size:150px;" class="fa-solid fa-circle-check text-success"></i>
            </span>
            <h1 class="fw-bold">شكرا لك!</h1>
            <h6 class="fw-bold"> تمت عملية الدفع بنجاح</h6>
           ...
           <br> <br>
            <p>
                <a class="btn btn-primary fw-bold btn-sm" href="{{ route("main") }}" role="button">الاستمرار للصفحة
                    الرئيسية</a>
            </p>
        </div>
    </div>
